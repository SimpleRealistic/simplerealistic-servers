// todo: check for rounded angles in acute tr formatter
...
Action SetupMove(int client, int &buttons, float angles[3], float vel[3])
{
	...
	*/
	...
	gF_PreviousOptimizedAngle[client] = ArcSine(30.0 / fSpeed) * 57.29577951308; // TODO: use proper formula for this
